...
nextrec:
    ...
    Private Sub cmdProcess()
        ...
        If txtTrtyNmbr.Text <> "99" Then A2str = txTrtyDesc
...
EventExitSub:
    ...
    Private Sub frmEoySchedp_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        OpenPeriod()
        GetPeriodRec()
        GetPeriodData()
    ...
    Sub RptDirTotal()
        ...
        Do Until rc = r4eof
            If Trim(f4str(RDp.RptMgaNmbr)) <> txtMgaNmbr.Text Then GoTo nextrec
            If txtTrtyNmbr.Text <> "99" And Trim(f4str(RDp.RptTrtyNmbr)) <> txtTrtyNmbr.Text Then GoTo nextrec
...
nextrec:
    ...
    Sub RptCedTotal()
        ...
        Do Until rc = r4eof
            If Trim(f4str(Rc1p.CedMgaNmbr)) <> txtMgaNmbr.Text Then GoTo nextrec
            If txtTrtyNmbr.Text <> "99" And Trim(f4str(Rc1p.CedTrtyNmbr)) <> txtTrtyNmbr.Text Then GoTo nextrec
...
nextrec:
    ...
    Sub ItdDirTotal()
        ...
        Do Until rc = r4eof
            If Trim(f4str(IDp.ItdMgaNmbr)) <> txtMgaNmbr.Text Then GoTo nextrec
            If txtTrtyNmbr.Text <> "99" And Trim(f4str(IDp.ItdTrtyNmbr)) <> txtTrtyNmbr.Text Then GoTo nextrec
...
nextrec:
    ...
    Sub ItdCedTotal()
        ...
        Do Until rc = r4eof
            If Trim(f4str(Ic1p.CedMgaNmbr)) <> txtMgaNmbr.Text Then GoTo nextrec
            If txtTrtyNmbr.Text <> "99" And Trim(f4str(Ic1p.CedTrtyNmbr)) <> txtTrtyNmbr.Text Then GoTo nextrec
...
nextrec:
    ...
    Sub UepDirTotal()
        ...
        Do Until rc = r4eof
            If Trim(f4str(UEp.UepMgaNmbr)) <> txtMgaNmbr.Text Then GoTo nextrec
            If txtTrtyNmbr.Text <> "99" And Trim(f4str(UEp.UepTrtyNmbr)) <> txtTrtyNmbr.Text Then GoTo nextrec
...
nextrec:
    ...
    Sub UepCedTotal()
        ...
        Do Until rc = r4eof
            If Trim(f4str(Uc1p.CedMgaNmbr)) <> txtMgaNmbr.Text Then GoTo nextrec
            If txtTrtyNmbr.Text <> "99" And Trim(f4str(Uc1p.CedTrtyNmbr)) <> txtTrtyNmbr.Text Then GoTo nextrec
...
Total:
    ...
    Private Sub btnCreateAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCreateAll.Click
        ...
        If Trim(txtPeriod.Text) = "" Then txtPeriod.Text = "12"
        optYTD.Checked = True
        optToFile.Checked = True
        For Each Ma In MgaArray

            If Ma = Nothing Then GoTo endprint
