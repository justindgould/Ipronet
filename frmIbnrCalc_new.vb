...
nextrec: 
    ...
    Sub CalcIbnr()
        ...
        'IBNR PRM Factors
        If Mid(Kstr, 1, 3) <> "001" Then IbnrPrmKey = Wperiod & Mid(Kstr, 6, 4) & "99999"
        If Mid(Kstr, 1, 3) = "001" Then IbnrPrmKey = Wperiod & Mid(Kstr, 6, 4) & "00199"
        If Mid(Kstr, 1, 3) = "057" Then IbnrPrmKey = Wperiod & Mid(Kstr, 6, 4) & "05799"
