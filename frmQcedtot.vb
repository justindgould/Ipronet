...
Friend Class frmQcedtot
    ...
    Private Sub frmQcedtot_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
...
nextrec:
            ...
            '=Get Prior Unearned
            '==================================================================================
            If Fct = 1 Then OpenItdCed1()
            If Fct = 2 Then OpenItdCed2()
            If Fct = 3 Then OpenItdCed3()
            If Fct = 4 Then OpenItdCed4()
            If Fct = 5 Then OpenItdCed5()
            ...
            Do Until rc = r4eof
                If Astr <> "991" And Astr <> "999" Then
                    If Trim(f4str(Ic1p.CedMgaNmbr)) <> Astr Then GoTo nextrec1
                End If

                If Astr <> "991" And Astr <> "999" And A4str <> "99" Then
                    If Trim(f4str(Ic1p.CedTrtyNmbr)) <> A4str Then GoTo nextrec1
                End If

                If Astr = "991" Then
                    If Trim(f4str(Ic1p.CedMgaNmbr)) = "001" Or Trim(f4str(Ic1p.CedMgaNmbr)) = "015" Or Trim(f4str(Ic1p.CedMgaNmbr)) = "016" Then
                        GoTo nextrec1
                    End If
                End If

                If Val(Trim(f4str(Ic1p.CedCatCode))) <> 4 Then GoTo nextrec1
...
nextrec1:
            ...
            If Fct = 1 Then ClsItdCed1() : f12 = 0
            If Fct = 2 Then ClsItdCed2() : f12 = 0
            If Fct = 3 Then ClsItdCed3() : f12 = 0
            If Fct = 4 Then ClsItdCed4() : f12 = 0
            If Fct = 5 Then ClsItdCed5() : f12 = 0
        Next Fct
    ...
    Sub RptPageHeading()
        ...
        prtobj.Print()
        prtobj.Print(C0str)
        prtobj.Print("QTR YTD Accumulation Report - Ceded", TAB(45), Astr & "  " & A1str, TAB(121), "Page " & Pcnt)
    ...
    Sub CovHeading(ByRef X As Short)
        Dstr = "PP "
