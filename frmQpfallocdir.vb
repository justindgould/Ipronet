...
Friend Class frmQpfallocdir
    ...
    Private Sub frmQpfallocdir_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
...
nextrec:
    ...
    Sub PrtPfAllocRpt()
        ...
        Do Until rc = r4eof
            ...
            If Trim(f4str(RDp.RptCatCode)) <> "01" And Trim(f4str(RDp.RptCatCode)) <> "02" Then GoTo nextrec
...
nextrec:
        ...
        If Astr <> "991" And Astr <> "999" Then
            prtobj.Print("Policy Fee Allocation Includes " & Trim(Astr) & " " & Trim(A1str) & " " & A4str & " " & A2str)
        End If
    ...
    Sub RptPageHeading()
        ...
        prtobj.Print()
        prtobj.Print(C0str)
        prtobj.Print("Policy Fee Allocation Report", TAB(45), Astr & "  " & A1str, TAB(121), "Page " & Pcnt)
