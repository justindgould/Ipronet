...
Friend Class frmRptSpc2
    ...
    Private Sub frmRptSpc2_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        OpenPeriod()
        GetPeriodRec()
        GetPeriodData()
...
EventExitSub:
    ...
    Public Sub PrtMgaRpt()
        ...
        Do Until rc = r4eof
            ...
            For X = 1 To 10 : A(X) = MLobp(X) : Next X
...
nextrec3:
    ...
    Sub RptPageHeading()
        ...
        H2 = "Private Passenger Premium & Loss Report To"
    ...
    Sub ChkTreatyMst()
        ...
        For X = 11 To 24
            If CovArry(X) = 1 Then CMrec = True
        Next X
