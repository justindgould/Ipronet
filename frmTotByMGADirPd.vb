...
Friend Class frmTotByMgaDirPd
    ...
    Private Sub frmTotByMgaDirPd_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        OpenPeriod()
        GetPeriodRec()
        GetPeriodData()
...
EventExitSub:
    ...
    Public Sub BldDirTot()
        ...
        Fname1 = My.Application.Info.DirectoryPath & "\" & Wperiod & " TOTBYMGAPD "
        ...
        Do Until rc = r4eof
            ...
            For X = 1 To 24
                T(n) = T(n) + A(X)
                If X > 6 And X < 11 Then T(2) = T(2) + A(X)
                If X > 16 And X < 21 Then T(3) = T(3) + A(X)
            Next X
...
nextrec:
    ...
    Sub WriteRec()
        ...
        PrintLine(1, f1, f2, f3, f4, f5, f6, f7)
